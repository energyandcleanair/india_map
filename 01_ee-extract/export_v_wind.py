...
OUTPUT_DRIVE = "v_wind_FIN"
START_DATE = "2005-01-01"
END_DATE = "2023-10-01"
start_list, end_list = generate_date_lists(START_DATE, END_DATE, step_months=3)

collection = ee.ImageCollection("ECMWF/ERA5_LAND/DAILY_AGGR").select("v_component_of_wind_10m")
...
for s_date, e_date in zip(start_list, end_list):
    ...
    output_name = "_".join(["v_component_of_wind_10m", s_date, "to", e_date])
