...
# ------------------------------
path_to_data = "../../input_data/"  # Replace with your base data directory
...
def load_and_sample_CO():
    ...
    if os.path.exists(input_file):
        ...
        df = pd.read_parquet(os.path.join(
            path_to_data, "df_for_imputation_test.parquet"))
    ...
    # add grid_id_50km
    grid_file = os.path.join(path_to_data, "grid_intersect_with_50km.csv")
    ...
    print("Unique grid_id_50km in sample:",
          df_sampled['grid_id_50km'].nunique())

    output_sampled = os.path.join(
        path_to_data, "ML_full_model", "CO_ml_df_sampled.csv")
...
def main():
    ...
    missing_file = os.path.join(
        path_to_data, "ML_full_model", "CO_missing_to_be_imputed.csv")
